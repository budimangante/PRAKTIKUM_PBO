...
public class TokoBatikSystem {
                    ...
                    case 1:
                        try {
                            ...
                            while (true) {
                                ...
                                if (inputUsername == "admin" || inputUsername.equalsIgnoreCase("admin")) {
                                    clearScreen();
                                    System.out.println("Username tidak boleh sama dengan admin.");
                                    continue;
                                }
    ...
    private static void tambahProduk() {
        ...
        try {
            int jumlahProduk = admin.getProdukList().size() + 1;
            String id = "PRDK" + String.format("%03d", jumlahProduk);
    ...
    private static void buatTransaksiBaru() {
        ...
        try {
            int jumlahPelanggan = admin.getPelangganList().size() + 1;
            String idPelanggan = String.format("PLG%03d", jumlahPelanggan);
            System.out.print("ID Pelanggan: " + idPelanggan + "\n");
